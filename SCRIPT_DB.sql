...
INSERT INTO `courses_platform`.`messages` (`id_message`, `message_content`, `sent_date`, `fk_id_course`, `fk_id_receiver`, `fk_id_sender`) VALUES ('1', 'EstudianteEnviaMensaje', '2024-05-30', '1', '2', '1');
...
INSERT INTO `courses_platform`.`submissions` (`id_submission`, `content`, `grade`, `submission_date`, `fk_id_assignment`, `fk_id_student`) VALUES ('1', 'Entrega', 5.0, '2024-06-01T01:30:01.24154', '1', '1');
