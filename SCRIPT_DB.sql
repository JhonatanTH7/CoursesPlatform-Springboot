...
INSERT INTO `courses_platform`.`messages` (`id_message`, `message_content`, `sent_date`, `fk_id_course`, `fk_id_receiver`, `fk_id_sender`) VALUES ('1', 'EstudiantesEnviaMensaje', '2024-05-30', '1', '2', '1');
